...
@section('title', 'Edit ' . $page->name . ' - Paradise IT Solutions')
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="template" name="template">
                                    ...
                                    <option class="p-3" value="13"
                                        @if ($page->template == 13) selected @endif>Payment Gateway</option>
                                    <option class="p-3" value="15"
                                        @if ($page->template == 15) selected @endif>Careers</option>
                                    <option class="p-3" value="16"
                                        @if ($page->template == 16) selected @endif>Client Registration</option>
                                    <option class="p-3" value="17"
                                        @if ($page->template == 17) selected @endif>Courses</option>
                                    <option class="p-3" value="14"
                                        @if ($page->template == 14) selected @endif>Sitemap</option>
                                </select>
                            </div>
