...
@section('title', 'Edit ' . $service->name . ' - Paradise IT Solutions')
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                    <a class="icon-modal" data-bs-toggle="modal" data-bs-target="#iconModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($service->icon)
                                                    @php
                                                        $icon = get_media($service->icon ?? '');
                                                    @endphp
                                                    <img id="icon_img" src="{{ asset($icon->fullurl) }}"
                                                        alt="{{ $icon->alt }}">
                                                @else
                                    ...
                                    <a class="btn btn-sm btn-danger d-none" id="icon_remove" href="javascript:void(0)"><i
                                            class="fa fa-trash"></i> Delete</a>

                                    <input class="" id="icon_id" type="hidden" name="icon"
