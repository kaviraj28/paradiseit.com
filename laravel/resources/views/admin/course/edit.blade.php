...
@section('title', 'Edit ' . $course->name . ' - Paradise IT Solutions')
                ...
                <form class="row" method="POST" action="{{ route('course.update', $course->id) }}"
                    ...
                    <div class="col-md-9">
                        <div class="card card-body main-description shadow br-8 p-4">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" id=""
                                            type="text" name="name" value="{{ old('name', $course->name) }}"
                                            placeholder="">
                                        @error('name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('slug') is-invalid @enderror" id=""
                                            type="text" name="slug" value="{{ old('slug', $course->slug) }}"
                                            placeholder="">
                                        @error('slug')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                <label for="other_description">Benefits</label>
                                <textarea class="form-control ckeditor2 br-8 @error('other_description') is-invalid @enderror" id="other_description"
                                    name="other_description" rows="10" placeholder="Enter Other Description">{{ old('other_description', $course->other_description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card card-body seo my-5 shadow br-8 p-4">
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control br-8" name="seo_schema" rows="10" placeholder="Enter Seo Schema">{{ old('seo_schema', $course->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                    <a class="banner-modal" data-bs-toggle="modal" data-bs-target="#bannerModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($course->banner)
                                                    @php
                                                        $banner = get_media($course->banner ?? '');
                                                    @endphp
                                    ...
                                    <input class="" id="banner_id" type="hidden" name="banner"
                                        value="{{ old('banner', $course->banner) }}">
                                    @error('banner')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <a class="feature-modal" data-bs-toggle="modal" data-bs-target="#featureModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($course->image)
                                                    @php
                                                        $feature = get_media($course->image ?? '');
                                                    @endphp
                                                    @if ($feature)
                            ...
                            <div class="card-footers d-flex justify-content-between">
                                <a class="btn btn-sm btn-success" href="{{ route('coursesingle', $course->slug) }}"
