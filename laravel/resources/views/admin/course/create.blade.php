...
@section('title', 'Create New Course - Paradise IT Solutions')
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control ckeditor2 br-8 @error('other_description') is-invalid @enderror" id="other_description"
                                    name="other_description" rows="10" placeholder="Enter Other Description">{{ old('other_description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
