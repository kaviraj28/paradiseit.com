        ...
        <a class="app-brand-link mx-auto my-0" href="{{ route('home') }}" target="_blank">
            @if ($setting['site_main_logo'])
                <img src="{{ $setting['site_main_logo'] ? asset(get_media($setting['site_main_logo'])->fullurl) : '' }}"
                    ...
                    height="50">
            @else
                <span class="app-brand-text demo menu-text fw-bolder ms-2">Paradise IT Solutions</span>
            @endif
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item @if (Request::segment(2) == 'contacts' || Request::segment(2) == 'clientRegistration') {{ 'active open' }} @endif">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item @if (Request::segment(2) == 'clientRegistration') {{ 'active open' }} @endif">
                    <a class="menu-link {{ Request::segment(2) == 'clientRegistration' ? 'active' : '' }}"
                        href="{{ route('clientRegistration.index') }}">
                        <i class="menu-icon tf-icons bx bxs-notepad"></i>
                        <div data-i18n="Accordion">Company Registration</div>
                    </a>
                </li>
        ...
        <li class="menu-item @if (Request::segment(2) == 'course') {{ 'active open' }} @endif">
            <a class="menu-link menu-toggle" href="javascript:void(0)">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'course' && Request::segment(3) == '' ? 'active' : '' }}"
                        href="{{ route('course.index') }}">
                        <i class="menu-icon tf-icons bx bx-book-reader"></i>
                        <div data-i18n="Accordion">All Courses</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'course' && Request::segment(3) == 'create' ? 'active' : '' }}"
                        href="{{ route('course.create') }}">
                        <i class="menu-icon tf-icons bx bxs-file-plus"></i>
                        <div data-i18n="Accordion">Create Course</div>
                    </a>
                </li>
        ...
        <li class="menu-item @if (Request::segment(2) == 'services' || Request::segment(2) == 'pricing') {{ 'active open' }} @endif">
            <a class="menu-link menu-toggle" href="javascript:void(0)">
        ...
        <li class="menu-item @if (Request::segment(2) == 'partner' || Request::segment(2) == 'clientTab') {{ 'active open' }} @endif">
            <a class="menu-link menu-toggle" href="javascript:void(0)">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'clientTab' ? 'active' : '' }}"
                        href="{{ route('clientTab.index') }}">
                        <i class="menu-icon tf-icons bx bxs-file-plus"></i>
