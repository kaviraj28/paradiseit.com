...
function paradiseit_scripts() {
	wp_enqueue_style( 'paradiseit-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'paradiseit-style', 'rtl', 'replace' );

	wp_enqueue_script( 'paradiseit-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
