...
class CustomPostTypeAndTaxonomy
{
	...
	public function init()
	{
		...
		add_action('init', [$this, 'register_client_post_type'], 11);
		add_action('init', [$this, 'register_price_post_type'], 11);
		add_action('init', [$this, 'register_faq_post_type'], 11);
		add_action('init', [$this, 'register_team_post_type'], 11);
		add_action('init', [$this, 'register_services_post_type'], 11);
		add_action('init', [$this, 'register_projects_post_type'], 11);
		add_action('init', [$this, 'register_project_taxonomy'], 11);
	}
	...
	public function register_client_post_type()
	{
		...
		$_name          = 'Clients';
		$post_type_slug = 'pit_clients';
		$post_rewrite = 'clients';
		$rewrite      = $post_rewrite ? array('slug' => $post_rewrite, 'with_front' => false) : array();
		$labels       = array(
			'name'                  => _x($_name, 'Post Type General Name', $this->text_domain),
			'singular_name'         => _x($singular_name, 'Post Type Singular Name', $this->text_domain),
	...
	public function register_price_post_type()
	{
		/*
		 * Company Post Type
		 * */
	...
	{
		$post_type_slug = array('pit_projects');
		$singular_name  = 'Project Category';
		$_name          = 'Project Category';
		$tax_slug       = 'pit_project_cat';
		$tax_rewrite    = 'project-category';
