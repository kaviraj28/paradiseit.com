        ...
        <div class="container-fluid p-0">
            <div class="works-slides owl-carousel owl-theme">
                <div class="single-works">
                    <img src="<?= get_template_directory_uri(); ?>/img/works-image/1.jpg" alt="image">
                ...
                <div class="single-works">
                    <img src="<?= get_template_directory_uri(); ?>/img/works-image/2.jpg" alt="image">
                    <a href="#" class="icon"><i data-feather="settings"></i></a>
                    <div class="works-content">
                        <h3><a href="#">Incredible infrastructure</a></h3>
                        <p>Lorem ipsum dolor amet, adipiscing, sed do eiusmod tempor incididunt ut labore dolore magna
                ...
                <div class="single-works">
                    <img src="<?= get_template_directory_uri(); ?>/img/works-image/3.jpg" alt="image">
                    <a href="#" class="icon"><i data-feather="settings"></i></a>
                    <div class="works-content">
                        <h3><a href="#">Incredible infrastructure</a></h3>
                        <p>Lorem ipsum dolor amet, adipiscing, sed do eiusmod tempor incididunt ut labore dolore magna
                ...
                <div class="single-works">
                    <img src="<?= get_template_directory_uri(); ?>/img/works-image/4.jpg" alt="image">
                    <a href="#" class="icon"><i data-feather="settings"></i></a>
                    <div class="works-content">
                        <h3><a href="#">Incredible infrastructure</a></h3>
                        <p>Lorem ipsum dolor amet, adipiscing, sed do eiusmod tempor incididunt ut labore dolore magna
                ...
                <div class="single-works">
                    <img src="<?= get_template_directory_uri(); ?>/img/works-image/5.jpg" alt="image">
                    <a href="#" class="icon"><i data-feather="settings"></i></a>
                    <div class="works-content">
                        <h3><a href="#">Incredible infrastructure</a></h3>
                        <p>Lorem ipsum dolor amet, adipiscing, sed do eiusmod tempor incididunt ut labore dolore magna
        ...
        <div class="container">
            ...
            <div class="feedback-slides">
                <div class="client-feedback">
                    <div>
                        <div class="item">
                            <div class="single-feedback">
                                <div class="client-img">
                                    <img src="<?= get_template_directory_uri(); ?>/img/client-image/1.jpg" alt="image">
                                </div>
                                <h3>John Lucy</h3>
                                <span>Web Developer</span>
                        ...
                        <div class="item">
                            <div class="single-feedback">
                                <div class="client-img">
                                    <img src="<?= get_template_directory_uri(); ?>/img/client-image/2.jpg" alt="image">
                                </div>
                                <h3>John Smith</h3>
                                <span>Web Developer</span>
                                <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                        ...
                        <div class="item">
                            <div class="single-feedback">
                                <div class="client-img">
                                    <img src="<?= get_template_directory_uri(); ?>/img/client-image/3.jpg" alt="image">
                                </div>
                                <h3>Maxwel Warner</h3>
                                <span>Web Developer</span>
                                <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                        ...
                        <div class="item">
                            <div class="single-feedback">
                                <div class="client-img">
                                    <img src="<?= get_template_directory_uri(); ?>/img/client-image/4.jpg" alt="image">
                                </div>
                                <h3>Ross Taylor</h3>
                                <span>Web Developer</span>
                                <p>Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan
                        ...
                        <div class="item">
                            <div class="single-feedback">
                                <div class="client-img">
                                    <img src="<?= get_template_directory_uri(); ?>/img/client-image/5.jpg" alt="image">
                                </div>
                ...
                <div class="client-thumbnails">
                    <div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/1.jpg" alt="client"></div>
                        </div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/2.jpg" alt="client"></div>
                        </div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/3.jpg" alt="client"></div>
                        </div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/4.jpg" alt="client"></div>
                        </div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/5.jpg" alt="client"></div>
                        </div>
                        <div class="item">
                            <div class="img-fill"><img src="<?= get_template_directory_uri(); ?>/img/client-image/1.jpg" alt="client"></div>
                        </div>
            ...
            <div class="partner-inner">
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-1.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover1.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-2.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover2.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-3.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover3.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-4.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover4.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-5.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover5.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-6.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover6.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-7.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover7.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-8.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover8.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-9.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover9.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-10.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover10.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-11.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover11.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-12.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover12.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-13.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover13.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-14.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover14.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-15.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover15.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-16.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover16.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-17.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover17.png" alt="partner">
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 col-sm-4">
                        <a href="#">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-18.png" alt="partner">
                            <img src="<?= get_template_directory_uri(); ?>/img/partner-img/partner-hover18.png" alt="partner">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="single-blog-post">
                        <div class="blog-image">
                            <a href="single-blog.html">
                                <img src="<?= get_template_directory_uri(); ?>/img/blog-image/1.jpg" alt="image">
                            </a>
                            <div class="date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        <div class="blog-image">
                            <a href="single-blog.html">
                                <img src="<?= get_template_directory_uri(); ?>/img/blog-image/2.jpg" alt="image">
                            </a>
                            <div class="date">
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-blog-post">
                        <div class="blog-image">
                            <a href="single-blog.html">
                                <img src="<?= get_template_directory_uri(); ?>/img/blog-image/3.jpg" alt="image">
                            </a>
                            <div class="date">
